...
of each round, now adopt the chain with the most intrinsic work. To simplify the
analysis, we assume that $\gamma = 0$.
...
which we consider honest by definition, and we set
$\work(G) = 1$ (an arbitrary constant).
