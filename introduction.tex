...
chains, the one with the most work is chosen as the canonical one. We modify this
...
and choose the heaviest chain based on this rule.
...
account. Previous modifications to the fork choice rule include
