...
\begin{itemize}
  ...
  \item We report on the production testnet deployment of our open, real-world system, in which
        more than 2000 miners from the community have participated with 500 million testnet transactions,
        and an average hash rate exceeding 50GH/s using the ProgPoW~\cite{progpow} hash algorithm.
  ...
  \item We simulate over 3000 years of continuous-time executions of both Bitcoin and PoEM
        ...
        range of adversarial resiliences. % TODO
