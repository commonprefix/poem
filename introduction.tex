...
where $H(B)$ denotes the hash of the block target. Intuitively, this corresponds to counting the
...
account, following our previous short paper ``POEM: Proof of Entropy Minima''~\cite{poem-short},
where the entropic fork choice rule was defined but not analyzed.
Previous modifications to the fork choice rule include
