...
python3 gamma_latency.py --file-name poem_gamma_latency_beta_0.1_g_1.7_gamma_0_70_20_monte_carlo_100000_error_0.1.json
python3 gamma_latency.py --file-name poem_gamma_latency_beta_0.3_g_0.4_gamma_0_70_35_monte_carlo_100000_error_0.1.json