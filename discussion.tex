...
Prism~\cite{prism}, Parallel Chains~\cite{parallel-chains}, and HLCR~\cite{hlcr}.
...
is indeed the best possible attack against Bitcoin. However, no such result exists for
