...
between these two values is immaterial to the protocol's output; see the technical
\emph{Hash Separation} lemma (Lemma~\ref{lem:hash-separation}) in the appendix.
