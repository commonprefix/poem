...
\end{lemma}
\begin{proof}
  By induction on $r_2 - r_1 \geq 0$. For the basis ($r_1 = r_2$), observe that
  ...
  $X_{r_2 - 1} > 0$. Observe that an honest party queried the random oracle
  with a chain of work $w' + X_{r_2 - 1}$ and broadcasted it to the network.
