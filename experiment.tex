...
\begin{figure}[h]
    ...
    \caption{Bitcoin vs PoEM latency over different adversarial ratios $\beta$ (logarithmic scale).
...
\begin{figure}[h]
    ...
    \caption{Bitcoin vs PoEM optimal block production rate $g$ over different adversarial ratios $\beta$ (logarithmic scale).
