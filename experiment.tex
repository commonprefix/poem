...
We ran multiple simulations\footnote{
    The simulation source code can be found
    at~\cite{poem-simulation-honest, poem-simulation-adversary,
             bitcoin-simulation-honest, bitcoin-simulation-adversary,
             shell-script-simulation, miner-code}.
}
