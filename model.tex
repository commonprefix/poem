...
of all the strings in the sequence, in order.
...
In the execution, each of the $n - t$ honest parties execute the Distributed Ledger
Protocol.
The adversary controls $t < n$ of the parties.
The adversary may behave arbitrarily.
